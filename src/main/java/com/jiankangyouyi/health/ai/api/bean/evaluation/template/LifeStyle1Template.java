...
/**
 * 生活方式模板1 : LIFE_STYLE_TEMPLATE_1
 * 
 * 
 * @author yangsongbo
 *
 */
public class LifeStyle1Template implements IEvaluationTemplate {
	...
	public LifeStyle1Template() {
		super();
	}
	
	public LifeStyle1Template(String classify, String imageUrl, List<String> value, String count, String unit) {
		super();
