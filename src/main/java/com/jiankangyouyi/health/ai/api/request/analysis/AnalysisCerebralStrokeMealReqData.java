...
/**
 * @ClassName AnalysisCerebralStrokeMealReqData
 * @Description 脑卒中人群饮食分析 请求bean
 * @Author wanggang
 * @Date 2019/5/9 15:18
 **/
public class AnalysisCerebralStrokeMealReqData extends HealthAiRequest<AnalysisMealGeneralResData> {
    private static final long serialVersionUID = 1L;

    /**
     * 请求链接
     */
    private static final String API_URL = "/v2/analysis/cerebral-stroke/meal.do";
