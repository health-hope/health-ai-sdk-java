...
/**
 * @ClassName AnalysisCoronaryMealReqData
 * @Description 冠心病人群饮食分析 请求bean
 * @Author wanggang
 * @Date 2019/5/9 15:23
 **/
public class AnalysisCoronaryMealReqData extends HealthAiRequest<AnalysisMealGeneralResData> {

    /**
     * 请求链接
     */
    private static final String API_URL = "/v2/analysis/coronary/meal.do";
