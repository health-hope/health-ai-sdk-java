 ...
 * 糖尿病人群饮食分析
 * 
 * @see /v2/analysis/diabetes/meal.do
 * @author yangsongbo
 *
 */
public class AnalysisDiabetesMealReqData extends HealthAiRequest<AnalysisMealGeneralResData> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/analysis/diabetes/meal.do";
