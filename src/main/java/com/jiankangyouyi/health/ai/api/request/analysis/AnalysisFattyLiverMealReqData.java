...
/**
 * @ClassName AnalysisFattyLiverMealReqData
 * @Description 脂肪肝人群饮食分析 请求bean
 * @Author wanggang
 * @Date 2019/5/9 15:29
 **/
public class AnalysisFattyLiverMealReqData extends HealthAiRequest<AnalysisMealGeneralResData> {

    /**
     * 请求链接
     */
    private static final String API_URL = "/v2/analysis/fatty-liver/meal.do";
