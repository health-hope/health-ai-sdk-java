...
/**
 * @ClassName AnalysisGoutMealReqData
 * @Description 痛风人群饮食分析 请求bean
 * @Author wanggang
 * @Date 2019/5/9 15:31
 **/
public class AnalysisGoutMealReqData extends HealthAiRequest<AnalysisMealGeneralResData> {

    /**
     * 请求链接
     */
    private static final String API_URL = "/v2/analysis/gout/meal.do";
