 ...
 * 高血压人群饮食分析
 * 
 * @see /v2/analysis/hypertension/meal.do
 * @author yangsongbo
 *
 */
public class AnalysisHypertensionMealReqData extends HealthAiRequest<AnalysisMealGeneralResData> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/analysis/hypertension/meal.do";
