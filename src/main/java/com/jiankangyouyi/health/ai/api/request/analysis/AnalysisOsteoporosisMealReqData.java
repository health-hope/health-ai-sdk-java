...
/**
 * @ClassName AnalysisOsteoporosisMealReqData
 * @Description 骨质疏松人群
 * @Author wanggang
 * @Date 2019/5/9 15:32
 **/
public class AnalysisOsteoporosisMealReqData extends HealthAiRequest<AnalysisMealGeneralResData> {
    /**
     * 请求链接
     */
    private static final String API_URL = "/v2/analysis/osteoporosis/meal.do";
