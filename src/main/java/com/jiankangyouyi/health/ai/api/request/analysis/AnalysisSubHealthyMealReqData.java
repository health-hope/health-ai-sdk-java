 ...
 * 亚健康人群饮食分析
 * 
 * @see /v2/analysis/sub-healthy/meal.do
 * @author yangsongbo
 *
 */
public class AnalysisSubHealthyMealReqData extends HealthAiRequest<AnalysisMealGeneralResData> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/analysis/sub-healthy/meal.do";
