 ...
 *
 * @since v2.0
 * @see /v2/query/gout/text/food/list.do
 * @author Ashon
 */
public class FoodTextQueryGoutRequest extends HealthAiRequest<FoodTextSpeechQueryGeneralResponse> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/query/gout/text/food/list.do";
