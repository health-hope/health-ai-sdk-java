 ...
 *
 * @since v2.0
 * @see /v2/query/healthy/text/food/list.do
 * @author yangsongbo
 */
@JavaBean
public class FoodTextQueryHealthyRequest extends HealthAiRequest<FoodTextSpeechQueryGeneralResponse> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/query/healthy/text/food/list.do";
