 ...
 *
 * @since v2.0
 * @see /v2/query/hypertension/text/food/list.do
 * @author yangsongbo
 */
public class FoodTextQueryHypertensionRequest extends HealthAiRequest<FoodTextSpeechQueryGeneralResponse> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/query/hypertension/text/food/list.do";
