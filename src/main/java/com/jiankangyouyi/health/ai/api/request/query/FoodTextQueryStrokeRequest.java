 ...
 *
 * @since v2.0
 * @see /v2/query/stroke/text/food/list.do
 * @author Ashon
 */
public class FoodTextQueryStrokeRequest extends HealthAiRequest<FoodTextSpeechQueryGeneralResponse> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/query/stroke/text/food/list.do";
