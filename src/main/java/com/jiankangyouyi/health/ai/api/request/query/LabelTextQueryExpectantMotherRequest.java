 ...
 *
 * @since v2.0
 * @see  /v2/query/expectant/text/label/list.do
 * @author yangsongbo
 */
public class LabelTextQueryExpectantMotherRequest extends HealthAiRequest<LabelTextSpeechQueryGeneralResponse> {
