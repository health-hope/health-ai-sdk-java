 ...
 *
 * @since v2.0
 * @see  /v2/query/fatty-liver/text/label/list.do
 * @author Ashon
 */
public class LabelTextQueryFattyLiverRequest extends HealthAiRequest<LabelTextSpeechQueryGeneralResponse> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/query/fatty-liver/text/label/list.do";
