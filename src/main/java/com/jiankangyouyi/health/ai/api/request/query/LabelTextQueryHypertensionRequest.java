 ...
 *
 * @since v2.0
 * @see  /v2/query/hypertension/text/label/list.do
 * @author yangsongbo
 */
public class LabelTextQueryHypertensionRequest extends HealthAiRequest<LabelTextSpeechQueryGeneralResponse> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/query/hypertension/text/label/list.do";
