 ...
 *
 * @since v2.0
 * @see /v2/query/osteoporosis/text/label/list.do
 * @author yangsongbo
 */
public class LabelTextQueryOsteoporosisRequest extends HealthAiRequest<LabelTextSpeechQueryGeneralResponse> {
