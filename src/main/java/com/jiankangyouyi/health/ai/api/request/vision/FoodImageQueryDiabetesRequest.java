 ...
 *
 * @since v2.0
 * @see /v2/food/element/diabetes
 * @author dongle
 */
public class FoodImageQueryDiabetesRequest extends HealthAiRequest<FoodElementQueryResponse> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/food/element/diabetes";
