 ...
 *
 * @since v2.0
 * @see /v2/food/element/hyperlipidemia
 * @author dongle
 */
public class FoodImageQueryHighBloodFatRequest extends HealthAiRequest<FoodElementQueryResponse> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/food/element/hyperlipidemia";
