 ...
 *
 * @since v2.0
 * @see /v2/food/element/hypertension
 * @author dongle
 */
public class FoodImageQueryHypertensionRequest extends HealthAiRequest<FoodElementQueryResponse> {
     ...
     * 请求链接
     */
    private static final String API_URL = "/v2/food/element/hypertension";
