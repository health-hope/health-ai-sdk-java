 ...
 *
 * @since v2.0
 * @see /v2/food/text/quey.do，/v2/food/speech/quey.do
 * @author yangsongbo
 */
public class FoodQueryGeneralResponse extends HealthAiResponse {
	 ...
	 * 食物列表
	 */
	private List<FoodQueryBean> foodList;

	public List<FoodQueryBean> getFoodList() {
		return foodList;
	}

	public void setFoodList(List<FoodQueryBean> foodList) {
		this.foodList = foodList;
	}

	public static class FoodQueryBean {
		...
		public String toString() {
			return "FoodQueryBean [foodId=" + foodId + ", count=" + count + ", foodName=" + foodName
					+ ", highlightText=" + highlightText + ", imageUrl=" + imageUrl + ", unit=" + unit
					+ ", relationNames=" + relationNames + ", efficacys=" + efficacys + ", describe=" + describe
					+ ", kilocalorie=" + kilocalorie + ", kilojoule=" + kilojoule + ", protein=" + protein + ", fat=" + fat
					...
					+ ", sodium=" + sodium + ", magnesium=" + magnesium + ", copper=" + copper + ", iron=" + iron
