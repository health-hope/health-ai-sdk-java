...
public class ImageFoodMultiRecognizeResponse extends HealthAiResponse {
	 ...
	 *
	 */
	public static class RecognizeMultiFood {
		/**
		 * 识别食物置信度
		 */
		 ...
		 * 识别出的食物数量
		 */
		private int recognitionFoodNum;
		...
		public int getRecognitionFoodNum() {
			return recognitionFoodNum;
		}

		public void setRecognitionFoodNum(int recognitionFoodNum) {
			this.recognitionFoodNum = recognitionFoodNum;
		}
